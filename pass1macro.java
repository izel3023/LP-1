...
{"MEND",null,null,null,null},
{"MACRO","SUBS","&F","&S",null},{null,"MOVER","BREG","&F",null},
...
if(!arr1.equals("MACRO")){
if(arr3 != null){
if(arr3.equals(d[n[nc-
1].def_index].def[1]))arr3 = "#1";
else if(arr3.equals(d[n[nc-
1].def_index].def[2]))
arr3 = "#2";
else if(arr3.equals(d[n[nc-
1].def_index].def[3]))
...
if(arr4 != null){
if(arr4.equals(d[n[nc-
1].def_index].def[1]))
arr4 = "#1";
else if(arr4.equals(d[n[nc-
1].def_index].def[2]))
arr4 = "#2";
else if(arr4.equals(d[n[nc-
1].def_index].def[3]))
...
if(arr5 != null){
if(arr5.equals(d[n[nc-
1].def_index].def[1]))
arr5 = "#1";
else if(arr5.equals(d[n[nc-
1].def_index].def[2]))
arr5 = "#2";
else if(arr5.equals(d[n[nc-
1].def_index].def[3]))
